...
const steps = [
  { num: '01', title: 'AUDIT', desc: 'Understand acquisition, lead flow, tools, and conversion bottlenecks.' },
  { num: '02', title: 'ARCHITECTURE', desc: 'Design the required revenue infrastructure and system integrations.' },
  { num: '03', title: 'BUILD', desc: 'Implement landing pages, CRM pipelines, AI qualification, and automations.' },
  { num: '04', title: 'INTEGRATE', desc: 'Connect the system directly into your existing operational workflows.' },
  { num: '05', title: 'DEPLOY', desc: 'End-to-end testing, team onboarding, and live system launch.' },
  { num: '06', title: 'OPTIMIZE', desc: 'Measure pipeline speed and continuously refine performance.' },
];

export const Process = () => {
  return (
    <section id="process" className="relative border-b border-border/50 bg-surface py-24 md:py-32 scroll-mt-[100px]">
